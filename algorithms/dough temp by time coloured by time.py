...
ids= "../rearangeddata/ids.csv"
process= "../rearangeddata/process.csv"
...
try:      
    ...
    fig.xlabel('Samplenumber', fontsize=16)
    fig.ylabel('temperature [°C]', fontsize=16)
